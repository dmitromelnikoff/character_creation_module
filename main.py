...
def attack(char_name: str, char_class: str) -> str:
    """Return the amount of damage to the enemy when attacking."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return the amount of damage blocked by the character
...
def special(char_name: str, char_class: str) -> str:
    """Return the amount of the applied special skill."""
    if char_class == 'warrior':
